                                    ...
                                    <ul className="category-list">
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/vegetable.svg"
                                                    alt=""
                                                />
                                        ...
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/cup.svg"
                                                    alt=""
                                                />
                                                <h6>Beverages</h6>
                                                <i className="fa-solid fa-angle-right" />
                                        ...
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/meats.svg"
                                                    alt=""
                                                />
                                                <h6>Meats &amp; Seafood</h6>
                                                <i className="fa-solid fa-angle-right" />
                                        ...
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/breakfast.svg"
                                                    alt=""
                                                />
                                        ...
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/frozen.svg"
                                                    alt=""
                                                />
                                                <h6>Frozen Foods</h6>
                                                <i className="fa-solid fa-angle-right" />
                                        ...
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/biscuit.svg"
                                                    alt=""
                                                />
                                        ...
                                        <li className="onhover-category-list">
                                            <a href="javascript:void(0)" className="category-name">
                                                <img
                                                    src="assets_client/svg/1/grocery.svg"
                                                    alt=""
                                                />
