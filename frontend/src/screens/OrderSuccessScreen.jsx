                            ...
                            <div className="breadscrumb-contain breadscrumb-order">
                                <div className="order-box">
                                    ...
                                    <div className="order-contain">
                                        <h3 className="theme-color">Chưa thanh toán</h3>
                                        <h5 className="text-content">
                                            Payment Is Successfully And Your Order Is On The Way
                                        </h5>
                                        <h6>Transaction ID: 4509968953132206</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                    ...
                                                    <div className="product border-0">
                                                        ...
                                                        <div className="product-detail">
                                                            <ul>
                                                                ...
                                                                <li className="text-content">Category: rau củ1</li>
                                                                <li className="text-content">Quantity: 1</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="price">
                                                    ...
                                                    <h6 className="theme-color">$4.00</h6>
                                                </td>
                                                <td className="quantity">
                                                    <h4 className="table-title text-content">Qty</h4>
                                                    <h4 className="text-title">1</h4>
                                                </td>
                                ...
                                <div className="col-lg-12 col-sm-6">
                                    <div className="summery-box">
                                        <div className="summery-header">
                                            <h3>Price Details</h3>
                                            <h5 className="ms-auto theme-color">(1 Items)</h5>
                                        </div>
                                        <ul className="summery-contain">
                                            ...
                                            <li>
                                                ...
                                                <h4 className="price theme-color">$0.00</h4>
                                            </li>
                                            <li>
                                                <h4>Coupon Discount</h4>
                                                <h4 className="price text-danger">$0.00</h4>
                                            </li>
                                        </ul>
