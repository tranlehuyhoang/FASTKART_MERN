                                ...
                                <ul className="about-list right-nav-about">
                                    <li className="right-nav-list">
                                        <div className="dropdown theme-form-select">
                                            ...
                                            >
                                                <img
                                                    src=" http://127.0.0.1:1000/assets_client/images/country/united-states.png"
                                ...
                                <div className="navbar-top">
                                    ...
                                    <div className="rightside-box">
                                        ...
                                        <ul className="right-side-menu">
                                            ...
                                            <li className="right-side">
                                                <a href="contact-us.php" className="delivery-login-box">
                                                    <div className="delivery-icon">
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            width={24}
                                            ...
                                            <li className="right-side">
                                                <a
                                                    href="http://127.0.0.1:1000/wishlist"
                                            ...
                                            <li className="right-side onhover-dropdown">
                                                ...
                                                <div className="onhover-div onhover-div-login">
                                                    <ul className="user-box-name">
                                                        <li className="product-box-contain">
                                                            <i />
                                                            <a href="http://127.0.0.1:1000/login">Log In</a>
                                                        </li>
                                                        <li className="product-box-contain">
                                                            <a href="http://127.0.0.1:1000/register">Register</a>
                                                        </li>
                                                        <li className="product-box-contain">
                                        ...
                                        <ul className="category-list">
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/vegetable.svg"
                                                        alt=""
                                                    />
                                            ...
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/cup.svg"
                                                        alt=""
                                                    />
                                                    <h6>Beverages</h6>
                                                    <i className="fa-solid fa-angle-right" />
                                            ...
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/meats.svg"
                                                        alt=""
                                                    />
                                                    <h6>Meats &amp; Seafood</h6>
                                                    <i className="fa-solid fa-angle-right" />
                                            ...
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/breakfast.svg"
                                                        alt=""
                                                    />
                                            ...
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/frozen.svg"
                                                        alt=""
                                                    />
                                                    <h6>Frozen Foods</h6>
                                                    <i className="fa-solid fa-angle-right" />
                                            ...
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/biscuit.svg"
                                                        alt=""
                                                    />
                                            ...
                                            <li className="onhover-category-list">
                                                <a href="javascript:void(0)" className="category-name">
                                                    <img
                                                        src=" http://127.0.0.1:1000/assets_client/svg/1/grocery.svg"
                                                        alt=""
                                                    />
                                                ...
                                                <ul className="navbar-nav">
                                                    ...
                                                    <li className="nav-item dropdown">
                                                        ...
                                                        <ul className="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a
                                                                    className="dropdown-item"
                                                                    href="http://127.0.0.1:1000/seller-list"
                                                                >
                                                                    Shop Seller
                                                                </a>
                                                            </li>
                                                    ...
                                                    <li className="nav-item dropdown dropdown-mega">
                                                        ...
                                                        <div
                                                            ...
                                                            style={{
                                                                backgroundImage: "url(../assets_client/images/bg.png)"
                                                            }}
                                                        >
                                                            <div className="row">
                                                    ...
                                                    <li className="nav-item dropdown">
                                                        ...
                                                        <ul className="dropdown-menu">
                                                            <li>
                                                                <a className="dropdown-item" href="blog-detail.php">
                                                                    Blog List
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <li className="nav-item dropdown">
                                                        ...
                                                        <ul className="dropdown-menu">
                                                            <li>
                                                                <a className="dropdown-item" href="seller-become.php">
                                                                    Become a Seller
                                                                </a>
                                                            </li>
                                                            <li>
