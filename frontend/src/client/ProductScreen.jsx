                            ...
                            <div className="row g-4">
                                                    ...
                                                    >
                                                        <div
                                                            ...
                                                            style={{
                                                                opacity: 1,
                                                                height: 1079,
                                                                transform: "translate3d(0px, -269px, 0px)"
                                                            }}
                                                        >
                                                            <div
                                ...
                                >
                                    <div className="right-box-contain">
                                        <h2 className="name">3</h2>
                                        <div className="price-rating">
                                            <h3 className="theme-color price">$3.00</h3>
                                        ...
                                        >
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div className="counter d-block">
                                                        <div className="seconds d-block">53</div>
                                                        <h6>Sec</h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <form action="cart/create" method="POST">
                                            <input
                                                type="hidden"
                                                name="_token"
                                                defaultValue="lOgOccGAbXYFJW9x7iGOetoJzF6ztSsMbAveJcs3"
                                                autoComplete="off"
                                            />{" "}
                                            <input
                                                type="text"
                                        ...
                                        <div className="buy-box">
                                            ...
                                            <a className="wishlist" href="#" data-product-id={12}>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width={24}
                                                    height={24}
                                                                    ...
                                                                    <div className="col-md-6">
                                                                        <div className="form-floating theme-form-floating">
                                                                            <input
                                                                                ...
                                                                                id="name"
                                                                                placeholder="2509roblox"
                                                                                disabled=""
                                                                            />
                                                                            <label htmlFor="name">2509roblox</label>
                                                                        </div>
                                                                    </div>
                                                                    <div className="col-md-6">
                                                                        <div className="form-floating theme-form-floating">
                                                                            <input
                                                                                ...
                                                                                className="form-control"
                                                                                id="email"
                                                                                placeholder="2509roblox@gmail.com"
                                                                                disabled=""
                                                                            />
                                                                            <label htmlFor="email">
                                                                                2509roblox@gmail.com
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <input
